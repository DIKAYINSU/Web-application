      ...
      <div className='md:h-[80vh'>
        ...
        <div className='grid grid-cols-1 pl-2 pr-2 md:grid-cols-2 md:pl-10 md:pr-10 ] '>
          ...
          <div className='p-7 md:p-2 order-2 md:order-1'>
            <h1 className='text-left font-bold text-3xl md:text-center pt-5 font-Roboto'>Railways Products</h1>
            ...
            <div className="text-base font-medium text-gray-800 transition-all duration-300 ease-in-out hover:scale-103 hover:text-black">
              <p className='font-Roboto text-lg pt-7'>
                We are proud to be on the <span className='font-semibold'>approved list of RDSO/DLW Varanasi</span> for the <span className='font-bold'>Resistor Unit of the Dynamic Braking Grid (DBR).</span> This recognition reflects our commitment to quality, precision, and reliability in serving the railway industry.
              </p>
            </div>
            <div className="text-base font-medium text-gray-800 transition-all duration-300 ease-in-out hover:scale-103 hover:text-black">
              <p className='font-Roboto text-lg pt-7'>
                Our major railway products include <span className='font-semibold'>Arc Box/Arc Chute Assemblies</span> (fabricated and moulded), <span className='font-semibold'>Slot Wedges, Pole Washers, FRP Cable Cleats, Insulation Kits for Smoothening Reactors, and Kits of Phenolic Bushes,</span> among others. Each product is manufactured using high-quality materials and strict quality control to ensure durability, safety, and consistent performance in demanding railway applications.
              </p>
            </div>
