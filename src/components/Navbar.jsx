        ...
        <div className={`${mobileMenuOpen ? '' : 'hidden'} w-full md:block md:w-auto`}>
          <ul className="flex flex-col md:flex-row font-medium p-4 md:p-0 mt-4 rounded-lg md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <NavLink
                to="/"
                className={`group relative block py-2 px-3 rounded-sm md:hover:bg-transparent md:p-0 ${isOverParticle ? 'text-white' : 'text-black hover:text-[#00a6f4]'
            ...
            >
              <button
                className={`flex items-center justify-between w-full py-2 px-3 rounded-sm hover:bg-gray-100 md:hover:bg-transparent ${isOverParticle ? 'text-white' : 'text-black hover:text-[#00a6f4]'
                  } md:p-0 md:w-auto`}
              >
                Products
                <svg
            ...
            <li
              ...
              onMouseLeave={() => {
                timeoutId_ = setTimeout(() => setsectorOpen(false), 200);
              }}
            >
              <button
                className={`flex items-center justify-between w-full py-2 px-3 rounded-sm hover:bg-gray-100 md:hover:bg-transparent ${isOverParticle ? 'text-white' : 'text-black hover:text-[#00a6f4]'
