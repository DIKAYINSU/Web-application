...
function Categories() {
  ...
  <div class="min-h-screen bg-gray-50 py-6 sm:py-12">
    <h1 class="a-heading">Product Categories We Specialize In</h1>

    <h3 class="a-subheading">We specialize in the manufacturing of high-quality FRP components through three core
    ...
    <div class="flex flex-wrap justify-center gap-6">
      ...
      {/* <!-- CARD 1 --> */}
      <div
        class="relative group w-[300px] cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:rounded-lg">
        <span
          class="absolute top-10 z-0 h-20 w-20 rounded-full bg-sky-500 transition-all duration-300 group-hover:scale-[14]"></span>
        <div class="relative z-10 mx-auto max-w-md">
          ...
          <h1 class="font-bold pt-5">Precision-Machined FRP Components</h1>
          <div
            class="space-y-6 pt-5 text-base leading-7 text-black-900 transition-all duration-300 group-hover:text-white/90">
          ...
          <div class="pt-5 text-base font-semibold leading-7">
            <p><a href="#" class="text-sky-500 transition-all duration-300 group-hover:text-white">Read More →</a></p>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        <div class="relative z-10 mx-auto max-w-md">
          <span
            class="grid h-20 w-20 place-items-center rounded-full bg-sky-500 transition-all duration-300 group-hover:bg-sky-400">
            {/* <!-- Icon --> */}
            <svg class="mycolor h-10" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512">
              <path
                d="M264.5 5.2c14.9-6.9 32.1-6.9 47 0l218.6 101c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L45.9 149.8C37.4 145.8 32 137.3 32 128s5.4-17.9 13.9-21.8L264.5 5.2zM476.9 209.6l53.2 24.6c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L45.9 277.8C37.4 273.8 32 265.3 32 256s5.4-17.9 13.9-21.8l53.2-24.6 152 70.2c23.4 10.8 50.4 10.8 73.8 0l152-70.2zm-152 198.2l152-70.2 53.2 24.6c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L45.9 405.8C37.4 401.8 32 393.3 32 384s5.4-17.9 13.9-21.8l53.2-24.6 152 70.2c23.4 10.8 50.4 10.8 73.8 0z" />
            </svg>
          </span>
          <h1 class="font-bold pt-5">High-Performance Molded FRP Parts</h1>
          ...
          <div class="pt-5 text-base font-semibold leading-7">
            <p><a href="#" class="text-sky-500 transition-all duration-300 group-hover:text-white">Read More →</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        <div class="relative z-10 mx-auto max-w-md">
          ...
          <h1 class="font-bold pt-5">Tailor-Made FRP & Insulation Solutions</h1>
